...
public abstract class ANTLRParserAdaptor<TParser extends Parser> implements PsiParser {
	private final Language language;

	protected ANTLRParserAdaptor(Language language) {
	...
	protected ANTLRParseTreeToPSIConverter createListener(TParser parser, IElementType root, PsiBuilder builder) {
		return new ANTLRParseTreeToPSIConverter(language, parser, builder);
	}

	/** Convert ANTLR parse tree to PSI tree. */
	protected void walkParseTree(ParseTree parseTree, ANTLRParseTreeToPSIConverter listener, IElementType root, PsiBuilder builder) {
